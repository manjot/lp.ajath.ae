...
<head>
    ...
    <title>Ecommerce App Development Services Dubai & UAE | Ajath Infotech</title>
...
<body class="bg-[#F8F9FF] text-[#464555] antialiased overflow-x-hidden">
    ...
    <section class="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
        ...
        <div class="max-w-5xl mx-auto px-6 text-center space-y-6">
            <span class="text-xs font-bold uppercase tracking-widest text-[#3525CD] bg-indigo-50 border border-indigo-100 px-3 py-1 rounded-full">Ecommerce Excellence</span>
            <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#0B1C30] tracking-tight leading-tight">
                Custom M-Commerce Solutions <br class="hidden sm:inline">Built for High-Growth UAE Brands
            </h1>
            <p class="text-slate-600 font-light text-lg max-w-3xl mx-auto leading-relaxed">
                We develop next-generation shopping applications optimized for the GCC market. From lightning-fast product search to frictionless checkouts, our eCommerce platforms are designed to maximize conversion and customer retention.
            </p>
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="space-y-3">
                    ...
                    <h3 class="text-lg font-bold text-[#0B1C30]">Local Payment Gateways</h3>
                    <p class="text-sm leading-relaxed text-slate-500 font-light">Seamless checkouts integrated with Middle East payment leaders including Telr, Checkout.com, Stripe, PayTabs, and Apple Pay.</p>
                </div>
                <div class="space-y-3">
                    <div class="w-10 h-10 rounded-lg bg-indigo-50 flex items-center justify-center text-[#3525CD] font-bold text-sm">02</div>
                    <h3 class="text-lg font-bold text-[#0B1C30]">Arabic RTL & Localization</h3>
                    <p class="text-sm leading-relaxed text-slate-500 font-light">Flawless right-to-left layout alignment and localized marketing messaging built specifically for UAE & GCC regional audiences.</p>
                </div>
                <div class="space-y-3">
                    <div class="w-10 h-10 rounded-lg bg-indigo-50 flex items-center justify-center text-[#3525CD] font-bold text-sm">03</div>
                    <h3 class="text-lg font-bold text-[#0B1C30]">Speed & Conversion Focus</h3>
                    <p class="text-sm leading-relaxed text-slate-500 font-light">Lightweight databases and optimized frontends providing sub-second page transition, quick cart additions, and instant search results.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-slate-50">
        <div class="max-w-5xl mx-auto px-6 text-center space-y-6">
            ...
            <p class="text-slate-600 font-light max-w-3xl mx-auto leading-relaxed">
                Our apps are designed specifically to succeed in the Middle East. We provide full RTL/Arabic layout support, integrate local logistics providers (Aramex, DHL, Fetchr), and ensure secure transactions compliant with local financial regulations.
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-[#0B1C30] text-white">
        <div class="max-w-5xl mx-auto px-6 text-center space-y-6">
            <h2 class="text-3xl font-extrabold tracking-tight">Have an eCommerce App Idea?</h2>
