...
<!-- End Google Tag Manager -->
    ...
    <title>Cross-Platform App Development Services Dubai & UAE | Ajath Infotech</title>
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <section class="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
        ...
        <div class="max-w-5xl mx-auto px-6 text-center space-y-6">
            <span class="text-xs font-bold uppercase tracking-widest text-[#3525CD] bg-indigo-50 border border-indigo-100 px-3 py-1 rounded-full">Cross-Platform Development</span>
            <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#0B1C30] tracking-tight leading-tight">
                Native Performance, Shared Codebase <br class="hidden sm:inline">Save 40% on App Development Costs
            </h1>
            <p class="text-slate-600 font-light text-lg max-w-3xl mx-auto leading-relaxed">
                We build high-fidelity, high-performance hybrid applications using Flutter and React Native. Ship to both iOS and Android stores simultaneously from a single clean codebase without sacrificing native look and feel.
            </p>
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="space-y-3">
                    ...
                    <h3 class="text-lg font-bold text-[#0B1C30]">Flutter & React Native Experts</h3>
                    <p class="text-sm leading-relaxed text-slate-500 font-light">Industry-best engineering utilizing modern component lifecycles, fast hot reloads, and robust third-party plug-in ecosystems.</p>
                </div>
                <div class="space-y-3">
                    <div class="w-10 h-10 rounded-lg bg-indigo-50 flex items-center justify-center text-[#3525CD] font-bold text-sm">02</div>
                    <h3 class="text-lg font-bold text-[#0B1C30]">Native Look & Feel</h3>
                    <p class="text-sm leading-relaxed text-slate-500 font-light">Custom widgets and layouts that match platform-specific HIG (Apple) and Material Design (Google) standards natively.</p>
                </div>
                <div class="space-y-3">
                    <div class="w-10 h-10 rounded-lg bg-indigo-50 flex items-center justify-center text-[#3525CD] font-bold text-sm">03</div>
                    <h3 class="text-lg font-bold text-[#0B1C30]">Frictionless Maintenance</h3>
                    <p class="text-sm leading-relaxed text-slate-500 font-light">Deploy updates, security patches, and features across both systems simultaneously from a unified source control repository.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-[#0B1C30] text-white">
        <div class="max-w-5xl mx-auto px-6 text-center space-y-6">
            <h2 class="text-3xl font-extrabold tracking-tight">Have a Hybrid App Idea?</h2>
