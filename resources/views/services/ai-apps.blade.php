...
<head>
    ...
    <title>AI-Powered Mobile App Development Services Dubai & UAE | Ajath Infotech</title>
...
<body class="bg-[#F8F9FF] text-[#464555] antialiased overflow-x-hidden">
    ...
    <section class="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
        ...
        <div class="max-w-5xl mx-auto px-6 text-center space-y-6">
            <span class="text-xs font-bold uppercase tracking-widest text-[#3525CD] bg-indigo-50 border border-indigo-100 px-3 py-1 rounded-full">AI-Powered Apps</span>
            <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#0B1C30] tracking-tight leading-tight">
                Smart Mobile Ecosystems <br class="hidden sm:inline">Integrating Generative AI & ML
            </h1>
            <p class="text-slate-600 font-light text-lg max-w-3xl mx-auto leading-relaxed">
                We design and build intelligent mobile applications powered by cutting-edge machine learning models, custom neural networks, and semantic Large Language Model (LLM) integrations to keep you ahead in Dubai's digital tech hubs.
            </p>
    ...
    <!-- Feature list -->
    <section class="py-16 bg-white border-y border-slate-200/40">
        <div class="max-w-7xl mx-auto px-6">
            <h2 class="text-center text-xs font-bold text-slate-400 uppercase tracking-widest mb-12">WHAT WE DELIVER</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="space-y-3">
                    <div class="w-10 h-10 rounded-lg bg-indigo-50 flex items-center justify-center text-[#3525CD] font-bold text-sm">01</div>
                    <h3 class="text-lg font-bold text-[#0B1C30]">GenAI & Chat Integrations</h3>
                    <p class="text-sm leading-relaxed text-slate-500 font-light">Custom integrations with top language models (GPT-4, Gemini) to deliver intelligent search, text automation, and contextual conversational bots.</p>
                </div>
                <div class="space-y-3">
                    <div class="w-10 h-10 rounded-lg bg-indigo-50 flex items-center justify-center text-[#3525CD] font-bold text-sm">02</div>
                    <h3 class="text-lg font-bold text-[#0B1C30]">Predictive Engines</h3>
                    <p class="text-sm leading-relaxed text-slate-500 font-light">Embed tailored recommendation loops, custom user clustering, behavior modeling, and analytics pipelines directly inside mobile processes.</p>
                </div>
                <div class="space-y-3">
                    <div class="w-10 h-10 rounded-lg bg-indigo-50 flex items-center justify-center text-[#3525CD] font-bold text-sm">03</div>
                    <h3 class="text-lg font-bold text-[#0B1C30]">On-Device Vision & Audio</h3>
                    <p class="text-sm leading-relaxed text-slate-500 font-light">Efficient machine learning models operating directly on mobile hardware to support image parsing, facial recognition, and voice processing.</p>
                </div>
            </div>
        </div>
    </section>

    <!-- GCC / UAE localization section -->
    <section class="py-20 bg-slate-50">
        <div class="max-w-5xl mx-auto px-6 text-center space-y-6">
            <h2 class="text-2xl sm:text-3xl font-extrabold text-[#0B1C30] tracking-tight">Localization & Regional Integrations</h2>
            <p class="text-slate-600 font-light max-w-3xl mx-auto leading-relaxed">
                Our apps are designed specifically to succeed in the Middle East. We provide full RTL/Arabic layout support, integrate local payment gateways (Telr, Checkout.com, Stripe), and ensure fast page loads for regional mobile networks.
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-[#0B1C30] text-white">
        <div class="max-w-5xl mx-auto px-6 text-center space-y-6">
            <h2 class="text-3xl font-extrabold tracking-tight">Have an AI-Powered App Idea?</h2>
