...
<head>
    ...
    <title>Android App Development Services Dubai & UAE | Ajath Infotech</title>
...
<body class="bg-[#F8F9FF] text-[#464555] antialiased overflow-x-hidden">
    ...
    <section class="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
        ...
        <div class="max-w-5xl mx-auto px-6 text-center space-y-6">
            <span class="text-xs font-bold uppercase tracking-widest text-[#3525CD] bg-indigo-50 border border-indigo-100 px-3 py-1 rounded-full">Android Development</span>
            <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#0B1C30] tracking-tight leading-tight">
                Scalable & Robust Android Apps <br class="hidden sm:inline">Optimized for GCC Ecosystems
            </h1>
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="space-y-3">
                    ...
                    <h3 class="text-lg font-bold text-[#0B1C30]">Kotlin & Modern Android SDK</h3>
                    <p class="text-sm leading-relaxed text-slate-500 font-light">Jetpack Compose and Kotlin-first frameworks, building fluid rendering, backward compatibility, and clean software architecture.</p>
                </div>
                <div class="space-y-3">
                    <div class="w-10 h-10 rounded-lg bg-indigo-50 flex items-center justify-center text-[#3525CD] font-bold text-sm">02</div>
                    <h3 class="text-lg font-bold text-[#0B1C30]">Device Diversity Optimization</h3>
                    <p class="text-sm leading-relaxed text-slate-500 font-light">Thorough testing across a massive matrix of Samsung, Xiaomi, and Google Pixel devices to secure unified styling and responsive layouts.</p>
                </div>
                <div class="space-y-3">
                    <div class="w-10 h-10 rounded-lg bg-indigo-50 flex items-center justify-center text-[#3525CD] font-bold text-sm">03</div>
                    <h3 class="text-lg font-bold text-[#0B1C30]">Google Play Compliant</h3>
                    <p class="text-sm leading-relaxed text-slate-500 font-light">End-to-end publishing expertise on the Google Play Store, managing app signing, API levels, target SDK configs, and user privacy guidelines.</p>
                </div>
            </div>
        </div>
    </section>
