...
<!-- End Google Tag Manager -->
    ...
    <title>UI/UX Design | App Delivery Process | Ajath Infotech</title>
    ...
    <section class="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
        ...
        <div class="max-w-5xl mx-auto px-6 text-center space-y-6">
            ...
            <p class="text-slate-600 font-light text-lg max-w-3xl mx-auto leading-relaxed">
                Our design team crafts pixel-perfect, highly engaging user interfaces that ensure smooth navigation and an unforgettable user experience.
            </p>
