...
<head>
    ...
    <title>Development | App Delivery Process | Ajath Infotech</title>
    ...
    <section class="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
        ...
        <div class="max-w-5xl mx-auto px-6 text-center space-y-6">
            ...
            <p class="text-slate-600 font-light text-lg max-w-3xl mx-auto leading-relaxed">
                We write clean, scalable, and secure code using agile methodologies, delivering regular builds so you can see your app come to life sprint by sprint.
            </p>
